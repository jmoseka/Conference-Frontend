...
const speakers = {
  column1: {
    image: 'https://i.postimg.cc/66cdYZfN/linkedin-sales-solutions-p-At-A8xe-i-VM-unsplash.jpg',
    names: 'Yochai Benki',
  ...
  column2: {
    image: 'https://i.postimg.cc/mDwFpxMS/thanh-duc-phan-i5-R8hb-ZFDdc-unsplash.jpg',
    names: 'Sheila Kizuga',
    profession: '',
  ...
  column3: {
    image: 'https://i.postimg.cc/3Jb2HHqS/joseph-gonzalez-i-Fg-Rcq-Hznqg-unsplash-1.jpg',
    names: 'Lee Pak',
  ...
  column4: {
    image: 'https://i.postimg.cc/ydBZT6Jd/prince-akachi-J1-OScm-u-HUQ-unsplash-1.jpg',
    names: 'Amara Akachi',
  ...
  column5: {
    image: 'https://i.postimg.cc/8PCL3CZf/michael-dam-m-EZ3-Po-FGs-k-unsplash.jpg',
    names: 'Queen Yori',
  ...
  column6: {
    image: 'https://i.postimg.cc/hv2TvFtG/christopher-campbell-r-DEOVt-E7v-Os-unsplash.jpg',
    names: 'Sheryl Amanda',
